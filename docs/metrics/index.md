...
AX tracks 9 metrics across three categories to give you the picture of how your agentic coding workflow is performing. Each metric has its own detailed doc — click through for the full story.
...
| 4 | [Iteration Depth](./iteration-depth.md) | Prompt Efficiency | Count of back-and-forth turn pairs (user to agent) per task | Session data | 2 |
| 5 | [Token Cost per PR](./token-cost-per-pr.md) | Prompt Efficiency | Dollar cost of tokens consumed across sessions correlated to a PR | Session data, Pricing module | 2 |
| 6 | [Cache Hit Rate](./cache-hit-rate.md) | Prompt Efficiency | Ratio of cache-read tokens to total input tokens | Session data | 2 |
| 7 | [Sidechain Rate](./sidechain-rate.md) | Agent Behavior | Fraction of messages on sidechain branches (backtracking) | Session data | 2 |
| 8 | [Re-Read Rate](./re-read-rate.md) | Agent Behavior | Total file reads divided by unique files read | Session data | 2 |
| 9 | [Autonomy Score](./autonomy-score.md) | Agent Behavior | Ratio of assistant to human messages | Session data | 2 |
...
**Metrics:** Post-Open Commits, CI Success Rate, Line Revisit Rate
