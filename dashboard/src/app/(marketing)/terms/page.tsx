...
export default function TermsPage() {
  return (
    <div className="max-w-[700px] mx-auto px-6 py-20">
      ...
      <div className="bg-surface-1 rounded-xl border border-border-subtle p-6 space-y-8">
        <Section title="1. Acceptance of Terms">
          <p>
            By accessing or using AX (&quot;the Service&quot;), you agree to be
        ...
        <Section title="2. Description of Service">
          <p>
            AX is a developer experience analytics service that measures coding
            workflow metrics by analyzing GitHub pull request data and Claude
            Code session metadata. The Service consists of a command-line tool,
            an API, and a web dashboard.
          </p>
        </Section>
        ...
        <Section title="3. Accounts and Access">
          <p>
            ...
            responsible for maintaining the security of your API keys and session
            tokens. You must notify us promptly if you believe your credentials
        ...
        <Section title="4. Data Collection and Privacy">
          <p>
            ...
            <Link href="/docs/data-collection" className="text-accent hover:underline">
        ...
        <Section title="5. Acceptable Use">
          <p>
            ...
            attempting to gain unauthorized access, interfering with other users,
            reverse-engineering the Service, or using the Service for any
            unlawful purpose.
          </p>
        </Section>
        ...
        <Section title="6. Plans and Billing">
          <p>
            ...
            continues through the end of the current billing period. Downgrades
            may result in loss of access to certain features and removal of
            team members exceeding the free plan limits.
          </p>
        </Section>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <h2 className="text-[15px] font-medium text-text-primary mb-2">{title}</h2>
