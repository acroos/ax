  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-void">
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <a
          href={`${apiUrl}/users/auth/github`}
          className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-lg bg-surface-2 hover:bg-surface-3 text-text-primary font-medium text-sm transition-colors border border-border-subtle"
        >
